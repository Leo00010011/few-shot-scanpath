...
from osie_prep.aggregate_seeds import (
    aggregate, composites, parse_headline, parse_run_log, to_markdown,
)
...
BASE_METRICS = {
    ...
    "VAME": {"SED": 6.2400, "STDE": 0.7100, "SED_best": 5.1000,
             "STDE_best": 0.8100},
...
def test_parses_padded_keys_and_names(tmp_path):
    ...
    assert metrics["VAME"]["STDE_best"] == pytest.approx(0.8100)
